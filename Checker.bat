@echo off
title System Information Checker - Created by Doub.cpp
color 0D
...
echo 6. Save All Information (.txt)
echo 7. Exit
echo.
...
:savefile
cls
echo Saving information to nigger.txt...
...
echo Information saved to nigger.txt
echo Press any key to return to the menu...
pause >nul
goto menu
